...
VALUES
    ('INT-DEV', 'GROUPE GLENAT', 'Intranet Dev glénat', '1.0.0', 'WEB',
     'https://intranet-dev.groupe-glenat.com/', '512', 'groupe-glenat.com',
     'intranet-dev./', 'support.informatique@glenat.com', 'www.glenat.com');

...
const SESSION_KEY = 'espace-titre-shuffle-order';
    ...
    <div className="p-6 space-y-6">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Espace titre</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <Card>
        ...
        <CardContent className="p-6">
          <CatalogueLayout active="Espace titre">
            <h3 className="mb-4 font-semibold text-xl">Espace titre</h3>
            ...
            {!loading && !error && filteredBooks.length === 0 && (
              <div className="flex items-center justify-center py-12 text-muted-foreground">
                <p>Aucun titre disponible pour le moment.</p>
              </div>
            )}
            ...
            {filteredBooks.length > 0 && (
              <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5">
                {filteredBooks.map(book => (
                  <BookCard key={book.ean} {...book} hideActions />
                ))}
              </div>
            )}
          </CatalogueLayout>

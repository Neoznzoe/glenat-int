...
export function ProjectDialog({
  ...
  useEffect(() => {
    if (project) {
      reset({
        ...
        DomainSub: project.DomainSub || '',
        AssistanceEmail: project.AssistanceEmail || '',
        WebsiteBrand: project.WebsiteBrand || '',
      });
    } else {
      reset({
        ProjectCode: '',
  ...
  const handleFormSubmit = async (data: CreateProjectPayload) => {
    await onSubmit(data);
    onOpenChange(false);
  };
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
          <div className="grid gap-4 max-h-[60vh] overflow-y-auto pr-2">
            <div className="grid gap-2">
              ...
              <Input
                id="ProjectCode"
                placeholder="Ex: INTRANET, WEBSITE"
                {...register('ProjectCode', { required: 'Le code du projet est requis' })}
              />
              {errors.ProjectCode && (
            ...
            <div className="grid gap-2">
              ...
              <Input
                id="ProjectName"
                placeholder="Ex: Intranet Glénat"
            ...
            <div className="grid gap-2">
              ...
              <Input
                id="Uri"
                placeholder="Ex: https://intranet.glenat.com"
                {...register('Uri')}
              />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <Input
                id="AssistanceEmail"
                type="email"
                placeholder="Ex: support@glenat.com"
                {...register('AssistanceEmail')}
              />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <Input
                id="WebsiteBrand"
                placeholder="Ex: Glénat Intranet"
                {...register('WebsiteBrand')}
              />
            </div>
          </div>

  ...
  useEffect(() => {
    if (page) {
      ...
      reset({
        PageCode: '',
        PageName: '',
        ModuleId: modules.length > 0 ? modules[0].ModuleId : '',
        PageType: null,
        TemplateKey: null,
        Description: null,
        IsActive: 1,
          ...
          <div className="grid gap-4 max-h-[60vh] overflow-y-auto pr-2">
            <div className="grid gap-2">
              ...
              <Input
                ...
                {...register('PageCode', { required: 'Le code de la page est requis' })}
              />
              {errors.PageCode && (
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                {...register('PageName', { required: 'Le nom de la page est requis' })}
              />
              {errors.PageName && (
            ...
            <div className="grid gap-2">
              ...
              <Controller
                name="ModuleId"
                control={control}
                rules={{ required: 'Le module est requis' }}
                render={({ field }) => (
                  <Select
                    value={field.value}
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                id="Description"
                placeholder="Ex: Page d'accueil du site"
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => setValue('IsPublished', checked ? 1 : 0)}
                />
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                id="MetaDescription"
                placeholder="Ex: Bienvenue sur le site de Glénat"
            ...
            <div className="grid gap-2">
              ...
              <Input
                id="MetaKeywords"
                placeholder="Ex: glénat, édition, bd, manga"
